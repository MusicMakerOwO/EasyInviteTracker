...
export class FolderWatcher {
	...
	onAdd: ((file: string, type: number) => void) | null;
	onRemove: ((file: string) => void) | null;
	onChange: ((file: string) => void) | null;
	...
	GetItemType(file: string): ObjectValues<typeof ItemType> {
		try {
	...
	WatcherEvent(path: string, event: 'change' | 'rename', filename: string | null) {
